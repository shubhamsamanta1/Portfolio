window.profileData = {
    name: "Shubham S. Samanta",
    role: "Software Development Engineer",
    location: "Mumbai, India",
    email: "shubhamsamanta9302@gmail.com",
    ...
    education: [
      {
        ...
        college: "From Shivajirao S Jondhale College of Engineering & Technology (Mumbai University Affiliated)",
        cgpa: "7.91/10",
        dates: "08/2017 – 07/2021",
        location: "Mumbai, India"
      }
    ],
  
    about: `Experienced Java Developer with a proven record in insurance domain projects. I thrive in fast-paced environments, always transforming challenges into growth opportunities. Dedicated to continuous learning, I actively expand my skills to stay current with evolving technologies. I’m driven to streamline workflows, integrate data, and enhance reporting, always aiming to deliver efficient solutions aligned with business goals.`,
    ...
    experience: [
      {
        ...
        location: "Mumbai, India",
        bullets: [
          "Built a high-performance Rate Vector Tool with RESTful APIs using Java and Spring Boot, cutting client workload by 50% and boosting batch processing speed/storage by 40%.",
          "Led end-to-end enhancements for life insurance products; developed scalable, event-driven AWS Lambda APIs with Python to drive cloud-native innovation."
        ],
        tech: ["Java", "Spring Boot", "SQL", "AWS (Lambda & EC2)", "Python"]
      },
      {
        company: "Accenture Solutions Pvt. Ltd.",
        role: "Software Engineering Analyst (Java Backend Developer)",
        date: "Sep 2021 – Oct 2024",
        location: "Mumbai, India",
        bullets: [
          "Developed optimized RESTful APIs using Java, Spring Boot, and Hibernate, enhancing product quality by 30% and improving user experience.",
          "Optimized SQL/database schemas to cut response times by 25%; led defect analysis, release management, and CI/CD automation via Jenkins and Rundeck."
        ],
    ...
    trainings: [
      ...
      "Successfully completed Java stream training conducted by Accenture Solutions.",
      "Successfully finished Azure beginner training, gaining foundational knowledge."
    ],
  
    recognitions: [
      "Accenture Celebrates Excellence Award (ACE)",
      "Pinnacle Award",
